...
<div class="modules-shell">
    ...
    <section class="modules-hero">
        <div class="modules-card">
            ...
            <p class="modules-text">Gestisci cosa è attivo nel gestionale web, cosa sarà disponibile nell'app mobile e cosa compare nei menu. Questa pagina è la base della configurazione modulare del software.</p>
        </div>
        <div class="modules-card">
            ...
            ?>
                <article class="module-card">
                    ...
                    <div class="module-toggles">
                        <label class="pill-toggle"><input type="checkbox" name="<?php echo h($k); ?>_web" <?php if(!empty($s['web'])) echo 'checked'; ?>> Web</label>
                        <label class="pill-toggle"><input type="checkbox" name="<?php echo h($k); ?>_app" <?php if(!empty($s['app'])) echo 'checked'; ?>> App</label>
                        <label class="pill-toggle"><input type="checkbox" name="<?php echo h($k); ?>_menu" <?php if(!empty($s['menu'])) echo 'checked'; ?>> Menu</label>
                    </div>
                </article>
            <?php endforeach; ?>
        </div>
