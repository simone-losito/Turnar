...
$settingsSections = [
    [
        'key' => 'general',
        'title' => 'Generali',
        'description' => 'Nome software, tagline, lingua, timezone, formati data e ora, anno di riferimento e impostazioni base dell’applicazione.',
        'status' => 'Disponibile',
    ...
    [
        ...
        'description' => 'Dati aziendali, logo società, favicon, immagine login, identità visiva e contenuti da richiamare in topbar e report.',
        'status' => 'Disponibile',
        'status_class' => 'success',
        'icon' => '🏢',
    ...
    [
        ...
        'description' => 'Dark mode, light mode, colori principali e secondari, stile della topbar, badge e preferenze visive future.',
        'status' => 'Disponibile',
        'status_class' => 'success',
        'icon' => '🎨',
    ...
    [
        ...
        'description' => 'Decidi se inviare notifiche app, email, entrambe oppure nessuna quando un turno viene assegnato.',
        'status' => 'Disponibile',
        'status_class' => 'success',
        'icon' => '🔔',
    ...
    [
        'key' => 'assignments',
        'title' => 'Turni',
        'description' => 'Orari predefiniti, pausa pranzo, gestione conflitti, conferme modifica, regole assegnazioni e comportamenti operativi.',
    ...
    [
        ...
        'description' => 'Intestazioni PDF, note standard, logo aziendale, dati fiscali, export CSV e parametri di stampa condivisi.',
        'status' => 'Da configurare',
        'status_class' => 'warning',
        'icon' => '📄',
        'href' => '#',
    ...
    [
        'key' => 'special-destinations',
        'title' => 'Destinazioni speciali',
        'description' => 'Logiche di ferie, permessi, malattia, corsi, flag speciali, conteggio assenze e comportamento nei report.',
        'status' => 'Da configurare',
        'status_class' => 'warning',
        'icon' => '📍',
        'href' => '#',
    ...
    [
        'key' => 'email',
        'title' => 'Email',
        'description' => 'SMTP, mittente, ricezione, reply-to, invio test, notifiche, reset password e base per comunicazioni future.',
        'status' => 'Da configurare',
        'status_class' => 'warning',
        'icon' => '✉️',
        'href' => '#',
    ...
    [
        'key' => 'mobile',
        'title' => 'Mobile / App',
        'description' => 'Parametri PWA/app, nome app, logo, splash, accesso mobile, notifiche, token dispositivo e configurazioni endpoint.',
    ...
    [
        ...
        'description' => 'Durata sessione, policy password, primo accesso, accesso web/app, ruoli, scope e parametri di sicurezza.',
        'status' => 'Da configurare',
        'status_class' => 'warning',
        'icon' => '🔐',
        'href' => '#',
    ...
    [
        ...
        'description' => 'Attivazione o disattivazione dei moduli del gestionale: dashboard, personale, destinazioni, turni, report, utenti e altro.',
        'status' => 'Da configurare',
        'status_class' => 'warning',
        'icon' => '🧩',
        'href' => '#',
    ...
    [
        'key' => 'backup',
        'title' => 'Backup / SQL',
        'description' => 'Backup database, import/export SQL, manutenzione, strumenti di ripristino, versioning e log operazioni future.',
        'status' => 'Area sensibile',
        'status_class' => 'danger',
        'icon' => '🛡️',
        'href' => '#',
        'available' => false,
